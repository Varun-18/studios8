...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Comprehensive security audits and quality assurance testing.",
      features: [
        "Security Audits",
        "Automated Testing",
        "Performance Testing",
  ...
  const process = [
    ...
    },
    {
      ...
      title: "Planning",
      description:
        "We create a detailed project roadmap with timelines and milestones.",
    },
    {
      step: "03",
      title: "Development",
      description:
        "Our team builds your solution using agile development methodologies.",
    },
    {
      step: "04",
      title: "Testing",
      description:
        "Rigorous testing ensures your application is bug-free and performant.",
    },
    {
      step: "05",
      title: "Deployment",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive software development services to bring your vision
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              ...
              >
                <div
                  className={`bg-gradient-to-r ${service.color} p-4 rounded-lg inline-block mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
